...
require (
	...
	github.com/cloudfoundry/bosh-davcli v0.0.280 // indirect
	github.com/cloudfoundry/bosh-gcscli v0.0.163 // indirect
	github.com/cloudfoundry/bosh-s3cli v0.0.230 // indirect
	github.com/cloudfoundry/config-server v0.1.141 // indirect
